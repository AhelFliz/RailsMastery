...
# Although these examples are a bit contrived, it is
# important to note that if we only need each teacher’s
# name it would be beneficial to use #flatten before iterating.
...
# so let’s chain it on the end of the block.
